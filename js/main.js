...
function changeImages(type) {
    var selectedImages = images[type];
    ...
    // Appliquer la classe 'active' au bouton sélectionné
...
function resetButtons() {
    // Réinitialiser tous les boutons en 'inactive'
...
document.getElementById('btnPoulet').classList.add('active');
document.getElementById('btnPoulet').classList.remove('inactive');
